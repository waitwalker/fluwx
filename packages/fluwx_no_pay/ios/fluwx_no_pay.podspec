...
Pod::Spec.new do |s|
  ...
  s.description      = <<-DESC
    fluwx_no_pay provides the same API as fluwx but the iOS binary contains no WeChat payment symbols.
    Calling payment methods returns false at runtime.
  ...
  s.vendored_frameworks = 'fluwx_no_pay/WechatOpenSDK-NoPay-SPM/WechatOpenSDK-NoPay-Dynamic.xcframework'
  s.platform         = :ios, '15.0'
  ...
  # 使用本地无支付符号版 WechatOpenSDK，并通过 FLUWX_NO_PAY 宏屏蔽支付代码。
